...
function Nn(r, t, e) {
  const { perQuad: n, aggregate: s } = oi(r, t), i = n.every((c) => c.length > 0), a = (e === "birdeye" ? i ? n : [s] : [s]).map((c) => ai(c));
...
function li(r) {
  const e = new ui(r).findSegmentIntersections(), n = Cn(e), s = /* @__PURE__ */ new Map();
  return n.forEach((i) => {
    s.set(`${i.x}:${i.y}`, i);
