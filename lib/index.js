...
export default class Tin {
    ...
    generatePointsSet() {
        ...
        for (let i = 0; i < this.edges.length; i++) {
            ...
            let previousFlag, previousNode, excludeArray = [];
            lengths
                ...
                return thisLengths
                    ...
                    val[4] === "handled"))  // 先頭ノード、最終ノード、および処理済みのノードはスキップ
                    ...
                    const anotherSets = anotherLengths.reduce((prev, item, index, arr) => {
                        ...
                        if (item[3] < ratio && next[3] > ratio)
                            return [item, next];    // ratioが完全一致する点がなければ、その前後の点をピックアップ
                        return;
                    }, undefined);
