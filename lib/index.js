...
function () {
  ...
  _createClass(Tin, [{
    ...
    value: function transform(apoint, backward, ignoreBounds) {
      ...
      var ret = transformArr(tpoint, tins, indexedTins, verticesParams, centroid, weightBuffer);
...
function transform(point, tins, indexedTins, verticesParams, centroid, weightBuffer) {
  // eslint-disable-line no-unused-vars
